...
- `idle_1` can repeat up to `IDLE_1_MAX_CONSECUTIVE = 3` times; after that, the next pick is forced from `{idle_2, idle_3}` (weighted).
- Weights: `{idle_1: 50, idle_2: 20, idle_3: 60}`. Effective long-run frequencies ≈ idle_1 58%, idle_3 32%, idle_2 10%.
